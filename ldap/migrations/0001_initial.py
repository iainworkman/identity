# Generated by Django 3.2.16 on 2022-12-15 22:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_class', models.CharField(help_text='Object class used when searching for and creating entries', max_length=250)),
                ('extra_read_filter', models.TextField(blank=True, help_text='Additional LDAP filters to apply when reading entries, in addition to the object_class')),
                ...
                ('is_authentication_source', models.BooleanField(default=False, help_text='Whether users from this source can participate in authentication')),
                ('authentication_priority', models.IntegerField(default=0, help_text='Determines the order in which sources will be checked when authenticating')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='The name of the Schema Mapping', max_length=150)),
        ...
        migrations.AddField(
            model_name='domainentrysource',
            name='schema_mapping',
            field=models.ForeignKey(help_text='The mapping of Domain Entry to User model, and vice versa', on_delete=django.db.models.deletion.CASCADE, related_name='+', to='ldap.schemamapping'),
        ),
        migrations.AddField(
